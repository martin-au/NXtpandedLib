...
extern int NXTCommFantom_send(nFANTOM100_iNXT nxt, const unsigned char* data, int offset, int len);
extern int NXTCommFantom_receive(nFANTOM100_iNXT nxt, unsigned char *data, int offset, int len);
