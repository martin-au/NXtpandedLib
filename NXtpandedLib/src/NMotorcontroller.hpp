...
public:
	...
	*/
	NMotorcontroller(NIMotor *motor, NMutex &controlMutex, S16 paraAmax, S16 paraVmax, S16 initialMotorPwr = 50)
		: mot(motor),
	 ...
	 * @param paraVmax Control-parameter maximum Velocity.
	*/
	NMotorcontroller(NIMotor *motor, NMutex &controlMutex, const EventMaskType &userMoveDoneEvent,S16 paraAmax, S16 paraVmax, S16 initialMotorPwr = 50)
		: mot(motor),
		  controlMtx(controlMutex),
		  M_SCALE(12),
		  amax(paraAmax),
